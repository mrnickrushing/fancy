      ...
      <div class="adm-section">
        ...
        <form id="settings-form" novalidate>
          ...
          <div class="row2">
            ...
            <div class="field"><label for="set-applepay">Apple Pay</label><input id="set-applepay" placeholder="phone or email"><p class="cal-note">The number or address Apple Cash should go to.</p></div>
          </div>
